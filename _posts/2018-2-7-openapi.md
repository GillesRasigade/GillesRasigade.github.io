...
Forget discrepancies between `apidoc` of `jsdoc` and your API implementation. As `chpr-openapi` is validating input output and  
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTExNzQwMzc0MV19
-->